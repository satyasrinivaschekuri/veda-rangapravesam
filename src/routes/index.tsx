      ...
      <Section id="repertoire" eyebrow="The Repertoire" title="A Journey Through the Kuchipudi Program" className="bg-secondary/40">
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {margams.map((item, i) => (
            ...
            >
              <div className="h-96 bg-muted flex items-center justify-center p-4">
                <img src={item.image} alt={item.name} width={800} height={600} loading="lazy" className="max-h-full max-w-full object-contain group-hover:scale-105 transition-transform duration-700" />
              </div>
